...
import com.qait.Domestic.automation.tests.EOLDomesticEnrollNow_nocourse_Test;
...
//		########### Message validation Payment Information Page  ######################
		...
		int ScenarioCount = AllCourse_EOLDomesticEnrollNow_nocourse_Tests.ScenarioCounter;
		...
		public void  verificationPaymentInformationPage()	
		{
			...
			EOLDomesticEnrollNow_nocourse_Test.PayScenarioGet = PaymentScenario;
...
//						if (PaymentScenario.contains("By Monthly; Checking or Savings Account")){

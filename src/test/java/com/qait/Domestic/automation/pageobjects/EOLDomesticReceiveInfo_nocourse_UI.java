...
import com.qait.Domestic.automation.tests.AllCourse_EOLDomesticEnrollNow_nocourse_Tests;
import com.qait.Domestic.automation.tests.AllCourse_EOLDomesticReceiveInfo_nocourse_Tests;
import com.qait.Domestic.automation.tests.EOLDomesticReceiveInfo_nocourse_Test;
...
public class EOLDomesticReceiveInfo_nocourse_UI extends AbstractClass {
	...
	@FindBy(xpath = "//select[@id='phcontent_0_phright_1_ddlxProgram']")
	...
	int ScenarioCount = AllCourse_EOLDomesticReceiveInfo_nocourse_Tests.ScenarioCounter;
	...
	public int getCourseCountFromPannFosterPage() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By
				.xpath("//select[@id='phcontent_0_phright_1_ddlxProgram']")));
	...
	public void selectCourseFromPannFosterPage(String Cource) {
		if (Utilities.getYamlValue(
			...
			WebElement OptionFordropdown = driver
					.findElement(By
							.xpath("//select[@id='phcontent_0_phright_1_ddlxProgram']/option["
									+ currentCourseUI + "]"));
		...
		Reporter.log(Utilities
				.logOutputFile(" Select a course from dropdown - Pass"),true);
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//b[contains(text(),'Thank You!')]")));
	...
	public void verifyPersonalInformationPage() {
		try {
			...
			Assert.assertTrue(firstNameTextBoxOnStep1Page
					...
					.equalsIgnoreCase(
							Utilities
									.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.FirstName")));
			Assert.assertTrue(lastNameTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(lastNameTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(lastNameTextBoxOnStep1Page.getAttribute("value")
					.equalsIgnoreCase(lname));
			...
			Assert.assertTrue(reTypeEmailTextBoxOnStep1Page
					...
					.equalsIgnoreCase(
							email
									+ "@"
									+ Utilities
											.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.EmailExt")));
			Assert.assertTrue(primaryPhoneTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(primaryPhoneTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(primaryPhoneTextBoxOnStep1Page
					...
					.equalsIgnoreCase(
							Utilities
									.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.PrimaryPhone")));
			Assert.assertTrue(address1TextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(address1TextBoxLabelOnStep1Page.isDisplayed());
			// //System.out.println("address is"
			// +address1TextBoxOnStep1Page.getAttribute("value"));
			// //System.out.println("expected address is "
			// +Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.Address"));
			Assert.assertTrue(address1TextBoxOnStep1Page
					.getAttribute("value")
					.equalsIgnoreCase(
							Utilities
									.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.Address")));
			Assert.assertTrue(address2TextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(address2TextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(cityTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(cityTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(cityTextBoxOnStep1Page
					...
					.equalsIgnoreCase(
							Utilities
									.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.City")));
			Assert.assertTrue(stateTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(stateTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(zipTextBoxOnStep1Page.isDisplayed());
			Assert.assertTrue(zipTextBoxLabelOnStep1Page.isDisplayed());
			Assert.assertTrue(zipTextBoxOnStep1Page
					.getAttribute("value")
					.equalsIgnoreCase(
							Utilities
									.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.ZIP")));
			Assert.assertTrue(communicateViaEmailCheckbox.isDisplayed());
			Assert.assertTrue(communicateViaEmailCheckboxLabel.isDisplayed());
			Assert.assertTrue(communicateViaTextMsgCheckbox.isDisplayed());
			Assert.assertTrue(communicateViaTextMsgCheckboxLabel.isDisplayed());
	...
	public void verificationPaymentInformationPage() {
		...
		Assert.assertTrue(courseHaadingOnPaymentInformationPage.getText()
				.equals(selectedCourseName));
		Reporter.log(Utilities
		...
		if(PaymentScenario.contains("Monthly Payment") || PaymentScenario.contains("Pay By Mail")){
			...
			if (radioButton.size() == 1){
				...
				AllCourse_EOLDomesticEnrollNow_nocourse_Tests.ScenarioCounter = ScenarioCount - 1;
		...
		EOLDomesticReceiveInfo_nocourse_Test.PayScenarioGet = PaymentScenario;
...
//		#################  Full Payment Mode  #################
		...
		if (parts[0].trim().equalsIgnoreCase("Full Payment")){
		    ...
		    if(str.contains("Please select your payment method:") &&  str.contains("PayPal") &&
			str.contains("Credit / Debit Card")  &&	str.contains("Checking / Savings Account") &&
			...
			if (parts[1].trim().equalsIgnoreCase("Checking or Savings Account")){	
			    ...
			    if (parts[2].trim().equalsIgnoreCase("Checking")){
...
//				    writeResult.writeColInExcelFile("Result", "Full Payment; Checking or Savings Account; Checking", currentCourseUI-1, 8);

			    }
			    
			    
			    if (parts[2].trim().equalsIgnoreCase("Savings")){
...
//				    writeResult.writeColInExcelFile("Result", "Full Payment; Checking or Savings Account; Savings", currentCourseUI-1, 8);
			...
			String CreditCardNumber = Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.CreditCardNumber");
			String CVV = Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.CVV"); 
...
//				#########################################
			...
			if (parts[1].trim().equalsIgnoreCase("Credit or Debit Card")){
				...
				String CreditCardNumber = Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.CreditCardNumber");
				String CVV = Utilities.getYamlValue("DomesticURLEnrollNownocourse.StudentInformation.CVV"); 
...

{
		...
		List<WebElement> check = driver.findElements(By.cssSelector("div[class^='column review-right']"));
			...
			m = check.get(9);			
			Assert.assertTrue(m.getText().contains(Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.DOBmonth")+"/"+Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.DOBday")+"/"+Utilities.getYamlValue("DomesticURLReceiveInformationnocourse.StudentInformation.DOByear")));

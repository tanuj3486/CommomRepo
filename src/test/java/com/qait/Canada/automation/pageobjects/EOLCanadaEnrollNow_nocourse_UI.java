...
//public class EOLCanadaEnrollNow_nocourse_UI {
//
//}
...
import com.qait.Canada.automation.tests.AllCourse_EOLCanadaEnrollNow_nocourse_Tests;
import com.qait.Canada.automation.tests.EOLCanadaEnrollNow_nocourse_Test;
...
//		########### Message validation Payment Information Page  ######################
		...
		int currentCourseUI = AllCourse_EOLCanadaEnrollNow_nocourse_Tests.initialCounter + 1;
		int ScenarioCount = AllCourse_EOLCanadaEnrollNow_nocourse_Tests.ScenarioCounter;
		...
		public void enterExtraInformationOnPersonalInformationPage(String preFix,
			...
			try {
				...
				System.out.println(firstNameTextBoxOnStep1Page.getAttribute("value"));
		...
		public void  verificationPaymentInformationPage()	
		{
			...
			if (radioButton.size() == 1){
				...
				AllCourse_EOLCanadaEnrollNow_nocourse_Tests.ScenarioCounter = ScenarioCount - 1;
			...
			EOLCanadaEnrollNow_nocourse_Test.PayScenarioGet = PaymentScenario;
			splitScenario();
...
//				}
		...
		public boolean acceptTermandConditionOnReviewAndSubmitPage()
		{
			...
			try{
				...
				if(Utilities.getYamlValue("CanadaURLEnrollNownocourse.SignDocElectronically").equalsIgnoreCase("yes")) {
					...
					String FullName = Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.FirstName")+ " "+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.LastName");
					try{
						

						String DOB = Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.DOBmonth")+ "/"+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.DOBday")+ "/"+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.DOByear");
						...
						Assert.assertTrue(StudentNameOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.FirstName").toUpperCase()));
						...
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.Address").toUpperCase()));
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.City").toUpperCase()));
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains((Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.ZIP")).replaceAll(" ", "")));
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains("ON"));
						...
						Assert.assertTrue(EmailOnElectronicSigAgreement.getText().contains(email.toUpperCase()+"@"+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.EmailExt").toUpperCase()));										
						...
						textboxNameOnElectronicSigAgreement.sendKeys(FullName);
					textboxEmailOnElectronicSigAgreement.sendKeys(email+"@"+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.EmailExt"));
					...
					try{
						...
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());																		
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.FirstName").toUpperCase()));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.Address").toUpperCase()));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.City").toUpperCase()));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.ZIP").replaceAll(" ", "")));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains("ON"));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(DOB));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(email.toUpperCase()+"@"+Utilities.getYamlValue("CanadaURLEnrollNownocourse.StudentInformation.EmailExt").toUpperCase()));

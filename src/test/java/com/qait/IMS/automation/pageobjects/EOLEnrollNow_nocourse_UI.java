...
import com.qait.IMS.automation.tests.AllCourse_EOLIMSEnrollNow_nocourse_Tests;
import com.qait.IMS.automation.tests.EOLIMSEnrollNow_nocourse_Test;
...
public class EOLEnrollNow_nocourse_UI  extends AbstractClass{
    ...
    public EOLEnrollNow_nocourse_UI(WebDriver driver) {
    	...
    	@FindBy(xpath = "//form[@id='form11']/a") 
		protected WebElement IMSURLEnrollNownocourse;		
...
//		@FindBy(xpath = "(//input[@value='OK'])[2]")
		@FindBy(id = "ctl00_ctl00_MasterContentPlaceHolder_NestedMasterContentPlaceHolder_Form_btn_PaymentFrequency_Submit")		
...
//		########### Message validation Payment Information Page  ######################
		...
		String email;
		String courseCost;
		int currentCourseUI = AllCourse_EOLIMSEnrollNow_nocourse_Tests.initialCounter + 1;
		int ScenarioCount = AllCourse_EOLIMSEnrollNow_nocourse_Tests.ScenarioCounter;
																	...
																	String Address, String City, String State, String Zip , String DOBmonth, String DOBday, String DOByear)	
		{
			...
			try {
				...
				WebDriverWait wait = new WebDriverWait(driver, 30 );
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@value='OK']")));					
		...
		public void  verificationPaymentInformationPage()	
		{
			...
			if(PaymentScenario.contains("Monthly Payment") || PaymentScenario.contains("Pay By Mail")){
				...
				if (radioButton.size() == 1){
					...
					AllCourse_EOLIMSEnrollNow_nocourse_Tests.ScenarioCounter = ScenarioCount - 1;
			...
			EOLIMSEnrollNow_nocourse_Test.PayScenarioGet = PaymentScenario;		
...
//			#################  Full Payment Mode  #################
			...
			if (parts[0].trim().equalsIgnoreCase("Full Payment")){
				...
				Assert.assertTrue(textboxFirstNameCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.FirstName")));
				...
				Assert.assertTrue(textboxAdderss1CreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.Address")));
				...
				Assert.assertTrue(textboxCityCreditCardOnPaymentInformationPage.getAttribute("value").equalsIgnoreCase(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.City")));
...
//	                                textboxZipCreditCardOnPaymentInformationPage.sendKeys(zipCode);
				...
				String CreditCardNumber = Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.CreditCardNumber");
				String CVV = Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.CVV"); 
...
//											
//        					    if (parts[3].trim().equalsIgnoreCase("Checking")){
//        						
//        						
//        						Select select = new Select(accountTypesavingsAccountDropdownOnPaymentInformationPage);
//        						select.selectByValue("C");
//       						
//        						routingNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("IMSURLEnrollNownocourse.RoutingNumber"));
//        						accountNumbersavingsAccountOnPaymentInformationPage.sendKeys(Utilities.getYamlValue("IMSURLEnrollNownocourse.AccountNumber"));
//        						proceedtoFinalStepCreditCardOnPaymentInformationPage.click();
//        						Reporter.log(Utilities.logOutputFile("Click on Proceed to Final Step button - PASS "));
//        						
////        						    writeResult.writeColInExcelFile("Result", "Monthly Payment; By Monthly; Checking or Savings Account; Checking", currentCourseUI-1, 8);
//
//        					    }
//					    
//					    
//        					    if (parts[3].trim().equalsIgnoreCase("Savings")){
//        
//        						
//        						
//        						Select select = new Select(accountTypesavingsAccountDropdownOnPaymentInformationPage);
...
//        						Reporter.log(Utilities.logOutputFile("Click on Proceed to Final Step button - PASS "));
//        						
////        						writeResult.writeColInExcelFile("Result", "Monthly Payment; By Monthly; Checking or Savings Account; Savings", currentCourseUI-1, 8);
//
//        					    }
//					    }
//					}
...
//					if (PaymentScenario.contains("By Monthly; Credit or Debit Card")){
		...
		public boolean acceptTermandConditionOnReviewAndSubmitPage()
		{
			...
			try{
				...
				if(Utilities.getYamlValue("IMSURLEnrollNownocourse.SignDocElectronically").equalsIgnoreCase("yes")) {
					...
					String FullName = Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.FirstName")+ " "+Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.LastName");
					try{
						String DOB = Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.DOBmonth")+ "/"+Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.DOBday")+ "/"+Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.DOByear");
						...
						Assert.assertTrue(StudentNameOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.FirstName").toUpperCase()));
						...
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.Address").toUpperCase()));
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.City").toUpperCase()));
//						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.ZIP")));
						Assert.assertTrue(StudentAddressOnElectronicSigAgreement.getText().contains("IND"));
						...
						Assert.assertTrue(EmailOnElectronicSigAgreement.getText().contains(email.toUpperCase()+"@"+Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.EmailExt").toUpperCase()));										
						
						if (PaymentScenario == "Full Payment; Credit or Debit Card"){
					...
					textboxEmailOnElectronicSigAgreement.sendKeys(email+"@"+Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.EmailExt"));
					...
					try{
						...
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());																		
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.FirstName").toUpperCase()));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.Address").toUpperCase()));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.City").toUpperCase()));
//						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.ZIP")));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains("IND"));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.isDisplayed());
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(DOB));
						Assert.assertTrue(StudentInfoOnElectronicSigAgreement.getText().contains(email.toUpperCase()+"@"+Utilities.getYamlValue("IMSURLEnrollNownocourse.StudentInformation.EmailExt").toUpperCase()));

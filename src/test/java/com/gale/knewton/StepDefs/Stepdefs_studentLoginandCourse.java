...
public class Stepdefs_studentLoginandCourse extends BaseTest {
	...
	@And("^I am on the Cengage Learning Login Page to login as student after log out$")
	public void I_am_on_the_Cengage_Learning_Login_Page_after_log_out() throws Throwable {
		loginPage.LaunchLoginpage();
	}

	@When("^I provide student username and password and hit login button$")
	public void I_provide_student_username_and_password() {
		String username = YamlReader.getYamlValue(YamlReader.getYamlValue("Environment")+"."+"student.userName"+"."+YamlReader.getYamlValue("title"));
		String password = YamlReader.getYamlValue(YamlReader.getYamlValue("Environment")+"."+"student.password");
	...
	@Then("^I click on Take me to the course$")
	public void i_click_on_Take_me_to_the_course()
	{
		ssoDashBoardPage.clickOnTakeMeToTheCourse();
	}
	
	
	@When("^I close Student window and log out from student$")
	public void dd(){
		ssoDashBoardPage.switchFromStudentViewToInstructor();
	}

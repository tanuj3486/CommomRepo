...
public class Stepdefs_inlineAssessment extends BaseTest {
	...
	public void i_save_inline_Simple_Assessment_activity_with_default_options() throws IOException {
		...
		mindTapDescriptionPage.enterTitleOnDescriptionLPNForm("InlineSimpleAssessmentActivity");
	...
	public void ef(){
		eBookDocPage.verifyNoScoreGeneratedAtInstructorEndAfterSubmittingInlineSA();
	}

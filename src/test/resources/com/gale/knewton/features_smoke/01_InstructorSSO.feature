 Feature: Login/Logout to SSO, Create, Enroll and Launch course
  ...
  @LoginAsInstructor @LoginAndersen @SmokeAndersen @SmokeGulati @report @smokeTest
  ...
  @CreateCourse @LogincreateLaunch @SmokeAndersen @SmokeGulati @3leg @smokeTest
  ...
  @LaunchCourse @LogincreateLaunch @LoginLaunch @SmokeAndersen @SmokeGulati @3leg @smokeTest @report
  ...
  @AcceptEulaIfAppears @LogincreateLaunch @SmokeAndersen @SmokeGulati @3leg @smokeTest 

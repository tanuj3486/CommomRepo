...
public class SAA_ActivityPage extends BaseWebComponent {
	...
	private String div_SelectedQuestionOnNavPanel_xpath = "//div[contains(@class,'sel-item') and contains(@class,'selected-item')]//div[contains(text(),'Question')]";
	private String btn_Submit_ForActiveQuestion_xpath = "//div[@class='current-item']//div[contains(text(),'Submit')]";
	...
	public void clickStartActivity(){
		...
		waitAndLocateElementByXpath(div_SelectedQuestionOnNavPanel_xpath);
		switchToDefaultContent();
	}
	...
	public void selectRadioBtn(){
		...
		switchToFrame(findElementById(frame2_Submit_id));
		hardWait(1);
		waitAndLocateElementByXpath(btn_Submit_ForActiveQuestion_xpath);
	...
	public void clickStartOnAssessmentActivityInfoPage(){
		waitAndLocateElementByXpath(btn_start_xpath).click();
	}
}

...
private String btn_takeMeToCourse_xpath="//div[@class='gracePeriodAction']/a[contains(.,'Take me')]";
	...
	public void switchFromStudentViewToInstructor(){
		closeCurrentWindow();
		hardWait(1);
		changeWindow(0);
		logout();
	...
	public void clickOnTakeMeToTheCourse() {
		try
		{
		//waitAndLocateElementByCss(btn_takeMeToCourse);
		findElementByXpath(btn_takeMeToCourse_xpath).click();
		...
		catch(NoSuchElementException e)
		{
			...
			{
				waitAndLocateElementByXpath(btn_takeMeToCourse_xpath);
				findElementByXpath(btn_takeMeToCourse_xpath).click();
